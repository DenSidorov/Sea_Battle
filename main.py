...
class Ship:
    def __init__(self, point, ship_len, vektor):
        self.point = point
...
class Game:
    ...
    def start(self):
        ...
        print('        "МОРСКОЙ БОЙ"')
        print('           ')
        print('Вы играете с компьютером на доске 6Х6')
        print('Корабли на поле расставляются рандомно')
